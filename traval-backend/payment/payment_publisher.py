...
class PaymentPublisher(object):
    ...
    def setup_exchange(self, exchange, exchange_type):
        ...
        be invoked by pika.
        :param str|unicode exchange: The name of the exchange to declare
        """
    ...
    def setup_queue(self, queue, durable):
        ...
        self._channel.queue_declare(
            queue=queue, durable=durable, callback=self.on_queue_declareok)

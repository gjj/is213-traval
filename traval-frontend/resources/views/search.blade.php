        ...
        <div class="row mb-8">
            ...
            <div class="col-lg-8 col-xl-9 order-md-1 order-lg-2 pb-5 pb-lg-0">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="font-size-21 font-weight-bold mb-0 text-lh-1">@{{ results_count }} activity found</h3>
                                ...
                                <div class="col-md-6 col-xl-4 mb-3 mb-md-4 pb-1">
                                    <div class="card transition-3d-hover shadow-hover-2 h-100">
                                        <div class="position-relative">
                                            <a href="{{ route('activity.item', 1) }}" class="d-block gradient-overlay-half-bg-gradient-v5">
                                            ...
                                            <div class="position-absolute bottom-0 left-0 right-0">
                                                <div class="px-4 pb-3">
                                                    <a href="{{ route('activity.item', 1) }}" class="d-block">
                                        ...
                                        <div class="card-body px-4 py-3">
                                            ...
                                            <div class="mt-2 mb-3">
                                                <span class="badge badge-pill badge-warning text-lh-sm text-white py-1 px-2 font-size-14 border-radius-3 font-weight-normal">@{{ avg_rating }}/5</span>
